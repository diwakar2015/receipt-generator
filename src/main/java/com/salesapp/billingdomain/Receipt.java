...
/**
 * The Receipt is the string representation of the products purchased with their
 * taxed cost, the total tax and total amount payable.
 * 
 * @author diwakarc
 */
public class Receipt {
	 ...
	 *            - the list of products purchased
	 * @param tax
	 *            - the net tax cost of all products
	 * @param amount
